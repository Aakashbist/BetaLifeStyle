...
namespace BetaLifeStyle.NicePayment
{
    public class PaymentHandler
    {
        ...
        public PaymentHandler(List<PaypalItem> items,int uid)
        {
            ...
            {
                DomainName = "https://localhost:44394";
            }
            else
            {
                DomainName = "http://betastyle-001-site1.gtempurl.com";
            }

            var redirUrls = new RedirectUrls()
            {
                cancel_url = DomainName + "/Cancel/",
                return_url = DomainName + "/Process/"
            };
            ...
            taxamount = ((double)_taxpercent / 100) * subtotal;

            var details = new Details()
            {
                tax = taxamount.ToString(),
                shipping = _fixedShipping.ToString(),
